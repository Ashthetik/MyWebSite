...
const Home = {
    ...
    <main id='home'>
        <div class="about__me">
            ...
            <h3>Full Stack Web Developer<br>Jnr. C++ Developer<br>Network Engineer</h3><br>
...
const Projects = {
        ...
        <header id="site_header" class="container d_flex">
            <div class="bio__media">
                ...
                <div class="bio__media__text">
                    <h1>Phoenix Reid</h1>
                    <h3>Full Stack Web Developer<br>Jnr. C++ Developer<br>Network Engineer</h3>
    ...
    methods:{
        fetchData: function () {
            axios.get(`https://api.github.com/users/KazutoKashima/repos?per_page=${this.perPage}`)
                .then(response => { 
